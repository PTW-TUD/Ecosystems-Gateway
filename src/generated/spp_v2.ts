...
export const serviceofferingPublisherService = {
  createOffering: {
    ...
    requestDeserialize: (value: Buffer) => CreateOfferingRequest.decode(value),
    responseSerialize: (value: CreateOfferingResponse) => Buffer.from(CreateOfferingResponse.encode(value).finish()),
  ...
  updateOffering: {
    ...
    requestDeserialize: (value: Buffer) => UpdateOfferingRequest.decode(value),
  ...
  updateOfferingLifecycle: {
    ...
    requestSerialize: (value: UpdateOfferingLifecycleRequest) =>
      Buffer.from(UpdateOfferingLifecycleRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => UpdateOfferingLifecycleRequest.decode(value),
    responseSerialize: (value: UpdateOfferingLifecycleResponse) =>
  ...
  runComputeToDataJob: {
    ...
    requestSerialize: (value: CreateComputeToDataRequest) =>
      Buffer.from(CreateComputeToDataRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateComputeToDataRequest.decode(value),
  ...
  getComputeToDataResult: {
    ...
    requestSerialize: (value: CreateComputeToDataResultRequest) =>
      Buffer.from(CreateComputeToDataResultRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateComputeToDataResultRequest.decode(value),
    responseSerialize: (value: GetComputeToDataResultResponse) =>
      Buffer.from(GetComputeToDataResultResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetComputeToDataResultResponse.decode(value),
  },
} as const;
...
export interface serviceofferingPublisherClient extends Client {
  ...
  getComputeToDataResult(
    ...
    callback: (error: ServiceError | null, response: GetComputeToDataResultResponse) => void,
  ): ClientUnaryCall;
  getComputeToDataResult(
    request: CreateComputeToDataResultRequest,
    metadata: Metadata1,
